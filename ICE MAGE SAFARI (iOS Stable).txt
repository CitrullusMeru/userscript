// ==UserScript==
// @name        ICE MAGE SAFARI (iOS Stable)
// @namespace   https://hentaiverse.org/
// @match       *://hentaiverse.org/*
// @version     1.1
// @description 2026.01.15 iOS Stable (No Audio)
// ==/UserScript==
...
(function () {
    ...
    if (!/s=Battle/.test(window.location.search) || !monsterPane) {
        console.log('🧊 ICE MAGE: not a battle page');
        return;
    }

    console.log('🧊 ICE MAGE iOS Stable initialized');
    ...
    const btnStart = makeBtn('MAGE START', '10px', '20px', async () => {
