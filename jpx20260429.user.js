...
let defaultCfgBattle = {
	...
	"Staff_General": {
		"supports": [
			...
			{"type":"item","name":"Mana Gem","conditions":[{"key":"pMP","value":[0,0.8]}]},
			{"type":"item","name":"Spirit Gem","conditions":[{"key":"pSP","value":[0,0.9]}]},
			{"type":"item","name":"Health Draught","conditions":[{"key":"pEffects","value":[-1,0,"Regeneration"]},{"key":"battleTypes","value":["Arena","Colosseum","Battle1000","Tower","Item"]}]},
			{"type":"item","name":"Mana Draught","conditions":[{"key":"pEffects","value":[-1,0,"Replenishment"]},{"key":"battleTypes","value":["Arena","Colosseum","Battle1000","Tower","Item"]}]},
			{"type":"item","name":"Infusion of Frost","conditions":[{"key":"pEffects","value":[-1,0,"Infused Frost"]},{"key":"battleTypes","value":["Arena","Colosseum","Battle1000","Tower","Item"]}]},
			{"type":"spellSupport","name":"Full-Cure","conditions":[{"key":"pHP","value":[0,0.2]}]},
			{"type":"spellSupport","name":"Cure","conditions":[{"key":"pHP","value":[0,0.55]}]},
			{"type":"spellSupport","name":"Full-Cure","conditions":[{"key":"pHP","value":[0,0.55]},{"key":"pActionCooldown","value":[1,99,"Cure"]}]},
			{"type":"item","name":"Health Potion","conditions":[{"key":"pHP","value":[0,0.55]},{"key":"pActionCooldown","value":[1,99,"Cure"]},{"key":"pActionCooldown","value":[1,99,"Full-Cure"]}]},
			{"type":"item","name":"Health Elixir","conditions":[{"key":"pHP","value":[0,0.3]},{"key":"pActionCooldown","value":[1,99,"Cure"]},{"key":"pActionCooldown","value":[1,99,"Full-Cure"]},{"key":"pActionCooldown","value":[1,99,"Health Potion"]}]},
			{"type":"item","name":"Last Elixir","conditions":[{"key":"pHP","value":[0,0.3]},{"key":"pActionCooldown","value":[1,99,"Cure"]},{"key":"pActionCooldown","value":[1,99,"Full-Cure"]},{"key":"pActionCooldown","value":[1,99,"Health Potion"]},{"key":"pActionCooldown","value":[1,99,"Health Elixir"]}]},
			{"type":"stop","customMessage":"Can't use Last Elixir HP","conditions":[{"key":"pHP","value":[0,0.3]}]},
			{"type":"item","name":"Mana Potion","conditions":[{"key":"pMP","value":[0,0.7]}]},
			{"type":"item","name":"Mana Elixir","conditions":[{"key":"pMP","value":[0,0.17]}]},
			{"type":"item","name":"Last Elixir","conditions":[{"key":"pMP","value":[0,0.17]},{"key":"pActionCooldown","value":[1,99,"Mana Potion"]},{"key":"pActionCooldown","value":[1,99,"Mana Elixir"]}]},
			{"type":"stop","customMessage":"Can't use Last Elixir MP","conditions":[{"key":"pMP","value":[0,0.17]}]},
			{"type":"item","name":"Spirit Draught","conditions":[{"key":"pSP","value":[0,0.75]},{"key":"battleTypes","value":["Arena","Colosseum","Battle1000","Tower","Item"]}]},
			{"type":"item","name":"Spirit Potion","conditions":[{"key":"pSP","value":[0,0.65]}]},
			{"type":"item","name":"Spirit Elixir","conditions":[{"key":"pSP","value":[0,0.25]}]},
			{"type":"item","name":"Last Elixir","conditions":[{"key":"pSP","value":[0,0.25]},{"key":"pActionCooldown","value":[1,99,"Spirit Potion"]},{"key":"pActionCooldown","value":[1,99,"Spirit Elixir"]}]},
			{"type":"stop","customMessage":"Can't use Last Elixir SP","conditions":[{"key":"pSP","value":[0,0.25]}]}
		],
		"attacks": [
			{"type":"smartDebuff","targetCount":3,"name":"Silence","bottomUp":true,"tailSkip":0,"maxAtFirst":10,"minMonstersLeft":10,"conditions":[{"key":"tIgnoredEffects","value":[1,9999,"Silenced"],"offset":[0,0],"matched":[1,1]},{"key":"tTypes","value":["Arena400","Arena500"],"offset":[0,0],"matched":[1,1]}]},
      {"type":"smartDebuff","targetCount":3,"name":"Silence","bottomUp":true,"tailSkip":2,"maxAtFirst":10,"minMonstersLeft":10,"conditions":[{"key":"tIgnoredEffects","value":[1,9999,"Silenced"],"offset":[0,0],"matched":[1,1]},{"key":"monsters","value":[8,10]}]},
			...
			{"type":"smartDebuff","targetCount":3,"name":"Weaken","bottomUp":false,"tailSkip":1,"maxAtFirst":10,"minMonstersLeft":10,"conditions":[{"key":"tIgnoredEffects","value":[1,9999,"Weakened"],"offset":[0,0],"matched":[1,1]},{"key":"monsters","value":[7,10]}]},
